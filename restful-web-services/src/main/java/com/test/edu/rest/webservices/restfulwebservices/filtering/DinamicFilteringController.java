...
public class DinamicFilteringController {
	...
	public MappingJacksonValue retriveSomeBean() {
		SomeDinamicBean someBean = new SomeDinamicBean("value1","value2","value3");
	...
	public MappingJacksonValue retriveListOfSomeBeans() {
		List<SomeDinamicBean> list = Arrays.asList(new SomeDinamicBean("value1","value2","value3"),new SomeDinamicBean("value11","value22","value33"));
